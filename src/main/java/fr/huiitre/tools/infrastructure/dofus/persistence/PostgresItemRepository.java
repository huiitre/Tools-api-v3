...
import fr.huiitre.tools.application.dofus.item.ItemPriceDto;
...
public class PostgresItemRepository implements ItemRepository {
    ...
    private static final RowMapper<ItemView> ITEM_VIEW_ROW_MAPPER = (rs, rowNum) -> {
        ...
        ItemPriceDto itemPriceDto = new ItemPriceDto(
            rs.getObject("user_price", Long.class),
            rs.getObject("community_price", Long.class),
            rs.getObject("last_updated_price", Long.class)
        );
