package fr.huiitre.tools.modules.dofus.sync.application.usecase.recipe;
...
import fr.huiitre.tools.modules.dofus.sync.application.usecase.SyncReport;
...
public class SyncRecipesUseCase implements SecuredUseCase {
    ...
    private static final Logger logger =
        LoggerFactory.getLogger(SyncRecipesUseCase.class);
    ...
    public SyncReport execute(GameVersionData gameVersion) {
        ...
        List<Item> items =
            itemRepository.findAllByGameVersionId(gameVersion.getId());
        ...
        List<RecipeSyncData> external =
            recipeDataProvider.fetchAll();
